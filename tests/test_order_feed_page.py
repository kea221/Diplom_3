...
class TestOrderFeedPage:
    ...
    def test_orders_from_order_history_displayed_in_order_feed(self, driver):
        ...
        order_feed_page = OrderFeedPage(driver)
        locator_number_in_feed = order_feed_page.get_locator_for_number_of_order_in_feed(number_from_history)
        assert order_feed_page.find_element(locator_number_in_feed)
    ...
    def test_number_of_order_appears_in_section_in_progress(self, driver):
        ...
        site_page.click_on_order_feed()
        order_feed_page = OrderFeedPage(driver)
        locator_number_in_progress = order_feed_page.get_locator_for_number_of_order_in_progress(number_of_order)
        order_feed_page.check_in_progress_is_visible()
        assert order_feed_page.find_element(locator_number_in_progress)
